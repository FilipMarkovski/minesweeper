...
public class FXMLDocumentController {
    ...
    @FXML
    public MenuBar GlavniMeniSeminarski;
    ...
    @FXML
    public MenuItem postaviTezinu;

    @FXML
    public Menu pravilaIgre;

    @FXML
    public MenuItem prikazInformacija;
            ...
            for (int y = 0; y < fieldColumns; y++) {
                ...
                b.setOnMouseClicked(e -> {
                    if (e.getButton() == MouseButton.PRIMARY) {
                        ms.open((Button) e.getSource());
                    } else if (e.getButton() == MouseButton.SECONDARY) {
                        ms.setFlag((Button) e.getSource());
                    }
